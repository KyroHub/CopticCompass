...
function createNotificationOperations(
  ...
  return {
    ...
    latestAcceptedEmailJobAt: null,
    latestExerciseSubmissionNotificationAt: null,
    latestExerciseSubmissionNotificationStatus: null,
    latestSignupNotificationAt: null,
    latestSignupNotificationStatus: null,
    ...
    recentSignupMissingNotificationCount: 0,
  ...
  it("builds operational alerts from bounded system metrics", () => {
    const alerts = buildAdminOperationalAlerts({
      ...
      operations: createNotificationOperations({
        ...
        recentSignupMissingNotificationCount: 1,
